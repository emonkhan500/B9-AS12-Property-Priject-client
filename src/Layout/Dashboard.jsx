        ...
        <ul className="menu space-y-2 mx-5">
          {isAdmin ? (
            <>
              <li>
                <NavLink
                  className="text-lg flex justify-center lg:justify-normal items-center "
                  to="/dashboard/adminprofile"
                >
                  <IoMdHome /> Admin Profile
                </NavLink>
              </li>
              <li>
                <NavLink
                  className="text-lg flex justify-center lg:justify-normal items-center "
                  to="/dashboard/managepropertybyadmin"
                >
                  <HiOutlineHomeModern /> Manage Properties
                </NavLink>
              </li>
              <li>
                <NavLink
                  className="text-lg flex justify-center lg:justify-normal items-center "
                  to="/dashboard/manageusersbyadmin"
                >
              ...
              <li>
                <NavLink
                  className="text-lg flex justify-center lg:justify-normal items-center "
                  to="/dashboard/managereviewsbyadmin"
                >
                  <GoCodeReview /> Manage reviews
                </NavLink>
              </li>
              <li>
                <NavLink
                ...
                >
                  <FcAdvertising /> Advertise Property
                </NavLink>
              </li>
            </>
          ) : isAgent ? (
            <>
              ...
              <li>
                ...
                >
                  <HiOutlineHomeModern /> Add Property
                </NavLink>
              </li>
              <li>
                <NavLink
                  className="text-lg flex justify-center lg:justify-normal items-center "
                  to="/dashboard/myaddedproperty"
                >
                  <HiOutlineHomeModern /> My added properties
                </NavLink>
              </li>
              <li>
                <NavLink
                  className="text-lg flex justify-center lg:justify-normal items-center "
                  to="/dashboard/soldproperty"
                >
                  <HiOutlineHomeModern /> My sold properties
                </NavLink>
              </li>
              <li>
                <NavLink
                ...
                >
                  <HiOutlineHomeModern /> Requested properties
                </NavLink>
              </li>
            </>
          ) : (
