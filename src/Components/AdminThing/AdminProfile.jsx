...
{user?.photoURL? <img className="w-24 rounded-full  " src={user?.photoURL} alt="" />:  <div >
	...
	<div className="space-y-4 text-center divide-y dark:divide-gray-300">
		<div className="my-2 space-y-1">
			...
			<p className="px-5 text-2xl sm:text-base dark:text-gray-600 font-semibold"><span className='text-xl mr-1 text-transparent bg-gradient-to-r from-[#3B9DF8] to-[#3BE8C4] bg-clip-text'>Profession:</span> MERN-stack Developer </p>
			...
			<p className="px-5 text-2xl sm:text-base dark:text-gray-600 font-semibold"><span className='text-xl mr-1 text-transparent bg-gradient-to-r from-[#3B9DF8] to-[#3BE8C4] bg-clip-text'>Role:</span> Admin!!</p>
		</div>
