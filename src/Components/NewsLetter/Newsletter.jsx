...
const Newsletter = () => {
  ...
  return (
    <div className=" bg-slate-100 shadow-lg px-2 xl:px-28 flex flex-col md:flex-row justify-center items-center  gap-2 md:gap-5 ">
      ...
      <Lottie animationData={newsletter} className="md:pl-36 xl:pl-48 h-[280px] md:h-[300px] lg:h-full" />
      </div>
      
      <div className="md:w-1/2  md:pr-12  xl:pr-40 rounded-sm text-center md:text-left">
