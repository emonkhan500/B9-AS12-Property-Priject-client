...
const Banner = () => {
  return (
    <div>
      <div className="carousel w-full h-[380px] md:h-[500px] lg:h-[600px] xl:h-[700px]">
        {/* skide 1 */}
  ...
  <div className="absolute inset-0 flex items-center justify-start px-12 text-center">
    <div className="text-white space-y-2 md:space-y-3 lg:space-y-4 xl:space-y-7 w-full">
      <h2 className="text-2xl md:text-4xl lg:text-5xl font-bold text-transparent bg-gradient-to-r from-[#3B9DF8] to-[#3BE8C4] bg-clip-text  px-0 lg:px-4 xl:px-28">
